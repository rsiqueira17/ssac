...
class Company_Window():
    def __init__(self, master):
        ...
        self.company_postcode = StringVar()
        ...
        self.out_company_postcode = Label(self.company, text='Cep', width=default.label_size, bg=default.bg_color, anchor=default.label_just)
        self.out_company_postcode.place(x=position_init_company_x, y=position_init_company_y + (default.lines_space * 3))
        ...
        self.out_company_address.place(x=position_init_company_x + 350, y=position_init_company_y + (default.lines_space * 3))
        ...
        self.out_company_number.place(x=position_init_company_x, y=position_init_company_y + (default.lines_space * 4))
        ...
        self.out_company_compl.place(x=position_init_company_x + 350, y=position_init_company_y + (default.lines_space * 4))
        ...
        self.out_company_neigh.place(x=position_init_company_x, y=position_init_company_y + (default.lines_space * 5))
        ...
        self.out_company_city.place(x=position_init_company_x + 350, y=position_init_company_y + (default.lines_space * 5))
        ...
        self.in_company_postcode = Entry(self.company, textvariable=self.company_postcode, width=9, bd=default.thickness_border, justify=default.entry_just)
        self.in_company_postcode.place(x=position_init_company_x + 115, y=position_init_company_y + (default.lines_space * 3))
        ...
        self.in_company_address.place(x=position_init_company_x + 465, y=position_init_company_y + (default.lines_space * 3))
        ...
        self.in_company_number.place(x=position_init_company_x + 115, y=position_init_company_y + (default.lines_space * 4))
        ...
        self.in_company_compl.place(x=position_init_company_x + 465, y=position_init_company_y + (default.lines_space * 4))
        ...
        self.in_company_neigh.place(x=position_init_company_x + 115, y=position_init_company_y + (default.lines_space * 5))
        ...
        self.in_company_city.place(x=position_init_company_x + 465, y=position_init_company_y + (default.lines_space * 5))
        ...
        # atalhos
        self.in_company_postcode.bind('<Return>', self.__search_cep_data)

        # posicao inicial cursor
        self.in_company_cnpj.focus()

        # carrega dados da tabela do bb
        self.__load_data_fields()


    def __record(self):
        # transformacoes
        compl = f"'{self.company_compl.get()}'" if self.company_compl.get() != '' else 'Null'
        km = self.km.get().replace('.', '')

        company = Company(
            self.company_cnpj.get(),
            self.company_name.get(),
            self.company_email.get(),
            self.company_phone.get(),
            self.company_cellphone1.get(),
            self.company_cellphone2.get(),
            self.company_postcode.get(),
            self.company_address.get(),
            self.company_number.get(),
            compl,
            self.company_neigh.get(),
            self.company_city.get(),
            self.number_init.get(),
            km,
            self.type.get(),
            self.time.get(),
            self.logo_file.get(),
        ...
        db.new_company(company)

        # reposiciona o cursor do teclado
        self.in_company_cnpj.focus()

        return
    

    def __load_data_fields(self):
        company = db.get_company()

        self.company_cnpj.set(company.cnpj),
        self.company_name.set(company.razao_social),
        self.company_email.set(company.email),
        self.company_phone.set(company.telefone),
        self.company_cellphone1.set(company.celular_1),
        self.company_cellphone2.set(company.celular_2),
        self.company_postcode.set(company.cep),
        self.company_address.set(company.endereco),
        self.company_number.set(company.endereco_numero),
        self.company_compl.set(company.endereco_complemento),
        self.company_neigh.set(company.endereco_bairro),
        self.company_city.set(company.endereco_cidade),
        self.km.set(company.garantia_km),
        self.type.set(company.garantia_tipo),
        self.time.set(company.garantia_tempo),
        self.number_init.set(company.os_numero_inicial),
        self.logo_file.set(company.logo_arquivo),
        self.local_os.set(company.local_os)
    ...
    def __search_cep_data(self, event):
        _, public_place, address, neigh, city, _, _ = viacep.get(self.company_postcode.get())

        self.company_address.set(f'{public_place} {address}')
        self.company_neigh.set(neigh)
        self.company_city.set(city)

        # reposiciona o foco do cursor para o numero do endereco para continuar com o cadastro
        self.in_company_number.focus()
